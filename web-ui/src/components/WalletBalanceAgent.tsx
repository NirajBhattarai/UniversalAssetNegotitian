...
const WalletBalanceAgent: React.FC<WalletBalanceAgentProps> = ({
  onMessage,
}) => {
  ...
  const networks = [
    {
      id: 'all',
      name: 'All Networks',
      description: 'Check all supported networks',
    },
    {
      id: 'hedera',
      name: 'Hedera Network',
      description: 'HBAR (Native Token)',
    },
    {
      id: 'ethereum',
      name: 'Ethereum Mainnet',
      description: 'ETH (Native), USDC/USDT (ERC20)',
    },
    {
      id: 'polygon',
      name: 'Polygon Network',
      description: 'MATIC (Native), USDC/USDT (ERC20)',
    },
  ];
            ...
            <div className='space-y-6'>
                      ...
                      <div className='space-y-2'>
                        ...
                        <div className='grid grid-cols-2 gap-4 text-sm'>
                          <div>
                            ...
                            <span className='ml-2 font-mono'>
                              {formatBalance(
                                networkData.nativeBalance.balanceFormatted,
                          ...
                          <div>
                            ...
                            <span className='ml-2 font-semibold'>
                              ${networkData.nativeBalance.usdValue.toFixed(2)}
                            </span>
                          </div>
                        </div>
                      </div>
              ...
              <div className='border-t pt-4'>
                ...
                <div className='flex gap-2'>
                  ...
                  {Object.values(balanceResult.networks).some(
                    network =>
                      network.tokenBalances && network.tokenBalances.length > 0
                  ) && (
                    <Badge
                      variant='secondary'
                      className='flex items-center gap-1'
