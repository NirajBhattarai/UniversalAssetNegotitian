...
// Payment methods configuration for the payment agent
export const PAYMENT_METHODS = [
  {
    id: 'hbar',
    name: TOKEN_CONFIGS.HBAR.name,
    rate: 0.05,
    minAmount: 10,
    blockchain: TOKEN_CONFIGS.HBAR.blockchain,
    tokenAddress: TOKEN_CONFIGS.HBAR.address,
    decimals: TOKEN_CONFIGS.HBAR.decimals,
    network: TOKEN_CONFIGS.HBAR.network
  },
  {
    id: 'usdc',
    name: TOKEN_CONFIGS.MOCK_USDC.name,
    rate: 1.0,
    minAmount: 1,
    blockchain: TOKEN_CONFIGS.MOCK_USDC.blockchain,
    tokenAddress: TOKEN_CONFIGS.MOCK_USDC.address,
    decimals: TOKEN_CONFIGS.MOCK_USDC.decimals,
    deploymentTx: TOKEN_CONFIGS.MOCK_USDC.deploymentTx,
    network: TOKEN_CONFIGS.MOCK_USDC.network
  },
  {
    id: 'usdt',
    name: TOKEN_CONFIGS.MOCK_USDT.name,
    rate: 1.0,
    minAmount: 1,
    blockchain: TOKEN_CONFIGS.MOCK_USDT.blockchain,
    tokenAddress: TOKEN_CONFIGS.MOCK_USDT.address,
    decimals: TOKEN_CONFIGS.MOCK_USDT.decimals,
    deploymentTx: TOKEN_CONFIGS.MOCK_USDT.deploymentTx,
    network: TOKEN_CONFIGS.MOCK_USDT.network
  }
] as const;
